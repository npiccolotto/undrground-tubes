...
cd $base
python render2.py --strategy $strategy --write-dir $TMPDIR --layouter mds --overlap-remover dgrid --connecter auto --router auto --read-dir $base/eval/dataset --dataset $dataset --weight $weight --connect-objective joint --serialize-graph 0 --compute-metrics 0 -w 18 -h 18
cp -r $TMPDIR $1
